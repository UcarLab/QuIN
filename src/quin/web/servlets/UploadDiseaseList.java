...
@MultipartConfig
public class UploadDiseaseList extends AbstractUploadServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public UploadDiseaseList(){
	...
	protected void insertValues(Connection conn, long fid, InputStream is,
		...
		String sql = "INSERT INTO diseaselists.d_" + fid + " VALUES(?)";
	...
	protected void createTable(Connection conn, long fid) throws SQLException {
		String sql = "CREATE TABLE diseaselists.d_" + fid
